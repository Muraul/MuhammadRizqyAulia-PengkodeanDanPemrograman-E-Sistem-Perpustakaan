        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Add Book Data Form</h3>
                </div>
                <div class="panel-body">
                    <!--membuat form untuk tambah data-->
                    <form class="form-horizontal" action="" method="post">
                        <div class="form-group">
                            <label for="loker_buku" class="col-sm-3 control-label">Book Locker</label>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label for="tahun_terbit" class="col-sm-3 control-label">Publication Year</label>
                            <div class="col-sm-3">
                        ...
                        <div class="form-group">
                            <label for="penerbit" class="col-sm-3 control-label">Book Publisher</label>
                            <div class="col-sm-9">
                                <input type="text" name="penerbit" class="form-control" id="inputPassword3" placeholder="Inputkan Penerbit Buku" required>
                            </div>
                        </div>
						<div class="form-group">
                            <label for="penerima" class="col-sm-3 control-label">Book Recipient</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2 col-xs-9">
								<select name="status" class="form-control">
									...
									<option value="Dipinjam">On Loan</option>
								</select>
                            </div>
                        </div>
                        <!--Akhir Status-->
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-9">
                                <button type="submit" class="btn btn-success">
                                    <span class="fa fa-save"></span> Save Book Data</button>
                            </div>
                        </div>
                    </form>
