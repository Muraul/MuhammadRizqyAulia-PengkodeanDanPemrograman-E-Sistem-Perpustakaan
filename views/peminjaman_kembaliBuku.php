        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Book Loan Return Date</h3>
                </div>
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
						...
						<div class="form-group">
                            <label for="tglPinjam" class="col-sm-3 control-label">Date of Loan</label>
                            <div class="col-sm-9">
						...
						<div class="form-group">
                            <label for="tglKembali" class="col-sm-3 control-label">Due Date</label>
                            <div class="col-sm-3">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-9">
                                <button type="submit" class="btn btn-success">
                                    <span class="fa fa-save"></span> Save Date</button>
