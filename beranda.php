    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Welcome to the Raul Library Information System</strong>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                     <table id="deskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="30%">Book Tittle</th><th>Author Name</th><th>Publisher Year</th><th>Book Locker</th><th>Status</th>
                            </tr>
                        </thead>
                        <tbody>
        ...
        <div class="col-sm-3 col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Welcome Muhammad Rizqy Aulia!</strong>
            </div>
            <?php
           } else { ?>
            ...
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Enter the System</h3>
                </div>
                <div class="panel-body">
